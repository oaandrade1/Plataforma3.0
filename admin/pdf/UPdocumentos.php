...
if (isset($_POST['subir'])) {
    ...
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            ...
            $db=new Conect_MySql();
            $sql = "INSERT INTO documentos(titulo,descripcion,tamanio,tipo,nombre_archivo) VALUES('$titulo','$descri','$tamanio','$tipo','$nombre')";
            ...
            <form method="post" action="" enctype="multipart/form-data">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <br><br>
                            <input type="submit" class="botones1" value="subir" name="subir"></td>
