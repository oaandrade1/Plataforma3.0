    ...
    <body>	
        ...
        <div class="centrar">
            <div class="panel-rojo">
                ...
                <form  method="POST" action="ActualizarI.php">
                    <table class="tabla txt16">
                        <tbody>
                                <tr> 
                                     <td style="vertical-align: middle">
                                        <label for="txtid">Id imagen</label>
                                    </td>
                                    <td >
                                        <input  type="text" name="txtid" id="txtid" value="<?php echo $row['id_imagen'];?>" style=" width: 196px;" readonly >
                                    </td>
                                     <tr>
                                    <td style="vertical-align: middle;">
                    ...
                    <div >
                        <table class="tabla2 centrar">
                            <tbody>
                             <td class="sinbordes" style="text-align: center"><button type="button" class="boton-cancelar" onclick="window.location.href='vistabuscarImg.html'">Cancelar</button></td>
