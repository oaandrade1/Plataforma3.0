...
<center>
<h3>Vamos a practicar la operación matemática Resta</h3></center>
<form action="/plataforma/practica/resta.php" method="POST">   		
<table border='0' align="center">
	<tr>
        <td width:auto>
			<img src='/plataforma/imagenes/7-1.png' title='siete - uno' alt="operacion matematica siete menos uno" width="100%" border="0" />
	<select name="t0" <?php echo calificar($temp[0],6);?>>
	...
	<!--Espacio entre columnas -->
		...
		<td width:auto>
			<img src='/plataforma/imagenes/5-2.png' title='tres + siete' alt="operacion matematica tres mas siete" width="100%" border="0" />
    ...
    <!--Espacio entre columnas -->
		...
		<td width:auto>
			<img src='/plataforma/imagenes/12-6.png' title='manzana' width="100%" border="0"/>
...
<table border='0' align="center">
	<tr>
        <td width:auto>
			<img src='/plataforma/imagenes/9-4.png' title='manzana' width="100%" border="0" />
	...
	<!--Espacio entre columnas -->
		...
		<td width:auto>
			<img src='/plataforma/imagenes/8-3.png' title='manzana' width="100%" border="0" />
    ...
    <!--Espacio entre columnas -->
		...
		<td width:auto>
			<img src='/plataforma/imagenes/15-5.png' title='manzana' width="100%" border="0"/>
